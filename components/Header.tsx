...
const Header: React.FC<HeaderProps> = ({ activeViewLabel }) => {
    return (
        <header className="sticky top-0 z-10 flex h-20 items-center justify-center bg-background/80 p-4 backdrop-blur-sm md:justify-center">
            ...
            <h1 className="text-xl font-bold tracking-tight capitalize text-text-primary">{activeViewLabel}</h1>
